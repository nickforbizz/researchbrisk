			...
			<div class="page-inner py-5">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					<div>
						...
						<h5 class="text-white op-7 mb-2">Categories for academic papers</h5>
					</div>
...
<script>
    $(document).ready(function() {
			$('#basic-datatables').DataTable({
                ...
                // scrollX: true,
                "order": [[ 0, "desc" ]],
                ajax: '{{ route('academicCategoryList') }}',
                columns: [
                    {data: 'name'},
                    {data: 'description'},
            ...
            $("#category_form").submit((e) => {
                ...
                let action_url = '';
                (form_action == 'A') ? action_url = "{{ route('academicCreateCategory')}}" : action_url = "academic_update_category/"+row_id;
                $.ajax({
                    url: action_url,
                    method: "post",
