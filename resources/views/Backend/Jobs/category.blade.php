			...
			<div class="page-inner py-5">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					<div>
						...
						<h5 class="text-white op-7 mb-2">Categories for Jobs</h5>
					</div>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <form class="form row " id="category_form">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input type="name" name="name" class="form-control" placeholder="Enter name" id="category_name" required >
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="category_descr">Description:</label>
                            <textarea name="description" class="form-control" cols="5" id="category_descr" placeholder="Enter description" required ></textarea>
                        </div>
                         <div class="col-sm-12">
                         <hr>
...
<script>
    $(document).ready(function() {
            ...
            $("#category_form").submit((e) => {
                ...
                let action_url = '';
                (form_action == 'A') ? action_url = "{{ route('jobCreateCategory')}}" : action_url = "job_update_category/"+row_id;
                $.ajax({
                    url: action_url,
                    method: "post",
